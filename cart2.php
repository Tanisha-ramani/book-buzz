...
?>
	...
	<div class="bg0 p-t-75 p-b-85">
		<div class="container">
			<div class="row">
				<div class="col-sm-10 col-lg-10  col-xl-7 m-b-50">
				...
				<div class="col-sm-2 col-lg-2  col-xl-5  m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<button class="flex-c-m stext-110 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" name="order" type="Submit" name="placeorder">
							Place Order
						</button>
						</form>
					</div>
