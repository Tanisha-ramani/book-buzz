					...
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<div class="p-t-33">
							...
							<div class="flex-w flex-r-m p-b-10">
								...
								<button onclick="location.href='carthandler.php?cart_id=<?php echo $final['id']?> &cart_name=<?php echo $final['name'] ?>&cart_price=<?php echo $final['price']?>'"class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04" name="addtocart">
										Add to cart
									</button>
								</div>
							</div>	
